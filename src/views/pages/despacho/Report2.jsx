...
import { Card, Col, Row, Input, Button, Table, message, Select, Spin, Modal, Typography, Flex, Radio, Tag } from "antd";
  ...
  const Report = () => {
    ...
    const fetchDriver = async () => {
        ...
        try{
            ...
            console.log('reponse data drivers: ', response.data.drivers);
    ...
    const handleAddReport = async (e) => {
      ...
      try {
        ...
        // const selectedProblem = problems.find(service => service.id === formData.problem);
        setReports(prevReports => [...prevReports, {...response.data.reports, driver: selectedDriver, problem: selectedProblem}]);
