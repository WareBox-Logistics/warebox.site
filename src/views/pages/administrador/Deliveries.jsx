...
const Deliveries = () => {
  ...
  const fetchDeliveries = async () => {
    ...
    try {
        ...
        const deliveriesData = deliveryResponse.data?.data || [];
        const deliveryDetailsData = deliveryDetailResponse.data?.details || [];
      ...
      <MainCard title="Deliveries">
        ...
        >
            ...
            <div>
                ...
                <Text><strong>Company:</strong> {selectedDelivery.company?.name || "N/A"}</Text><br />
                ...
                {selectedDelivery.pallets.length > 0 ? (
                    ...
                    <div key={palletId}>
                        <Text strong>Pallet ID:</Text> {palletId}<br />
                        ...
                        {selectedDelivery.boxes
                            ...
                            .map((box) => (
                            <li key={box.id}>
                                <Text>Product: {box.product?.name || "N/A"} - Qty: {box.qty}</Text>
                            </li>
                            ))}
                        </ul>
                    </div>
